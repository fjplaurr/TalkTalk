...
/**
 * Created by FranciscoJavier2 on 12/12/2017.
 */
...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        String from_user_id=remoteMessage.getData().get("from_user_id"); //Necesito el nombre del user que envía
                //la solicitud ya que tengo q poner un extra en el intent ya q así lo requiere la clase ProfileActivity.
