                    ...
                    mUserDatabase.child(current_user_id).child("device_token").setValue(deviceToken).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                //(LoginActivity) y Clear_Task elimina todas las otras tasks que estaban abiertas hasta ahora dejando la nueva task creada con New_task como la única. Con ésto consigo que activity_main pase
                                //a ser la actividad arriba de la pila de la nueva task y que, por tanto, al pulsar atrás, regrese al escritorio inicial del Smartphone en lugar de al activity_login.
