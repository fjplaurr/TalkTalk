    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStatusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String status_value=mStatus.getText().toString();   //Quiero enviar el status al StatusActivity para mostrarlo.
                                         ...
                                         mUserDatabase.updateChildren(update_hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                             ...
                                             public void onComplete(@NonNull Task<Void> task) {
                                                 if (task.isSuccessful()) {
                                                     ...
                                                     Toast.makeText(SettingsActivity.this, "Success Uploaded", Toast.LENGTH_LONG).show();
                                                 }
                                             }
                                         });
                                     } else {
                                         Toast.makeText(SettingsActivity.this, "Error uploading thumbail", Toast.LENGTH_LONG).show();
                                         mProgressDialog.dismiss();
                                     }
                                 }
                             });
